...
package org.wso2.ballerinalang.bir.codegen.interop;
...
import org.wso2.ballerinalang.bir.codegen.model.CatchIns;
import org.wso2.ballerinalang.bir.codegen.model.JCast;
import org.wso2.ballerinalang.bir.codegen.model.JErrorEntry;
...
import static org.wso2.ballerinalang.bir.codegen.desugar.BirDesugar.getNextDesugarBBId;
import static org.wso2.ballerinalang.bir.codegen.desugar.BirDesugar.insertAndGetNextBasicBlock;
/**
...
public final class InteropMethodGen {
    ...
    static void genJFieldForInteropField(JFieldBIRFunction birFunc, ClassWriter classWriter, PackageID birModule,
        ...
        if (birFuncParamIndex < birFuncParams.size()) {
            ...
            loadMethodParamToStackInInteropFunction(mv, birFuncParam, jFieldType, paramLocalVarIndex, instGen,
                    jvmCastGen);
        }
    ...
    public static void genVarArg(MethodVisitor mv, BIRVarToJVMIndexMap indexMap, BType bType, JType jvmType,
        ...
        if (TypeTags.isIntegerTypeTag(elementTypeTag)) {
            ...
            mv.visitMethodInsn(INVOKEINTERFACE, ARRAY_VALUE, "getBString", GET_BSTRING_FOR_ARRAY_INDEX, true);
        } else {
