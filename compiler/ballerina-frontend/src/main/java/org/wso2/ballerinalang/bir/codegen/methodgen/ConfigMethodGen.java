...
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.CONFIGURE_INIT_ATTEMPTED;
...
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.POPULATE_CONFIG_DATA_METHOD;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.VARIABLE_KEY;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.ADD_MODULE_CONFIG_DATA;
...
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.INTI_VARIABLE_KEY;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.POPULATE_CONFIG_DATA;
...
public class ConfigMethodGen {
    ...
    private void generateStaticFields(ClassWriter cw, String innerClassName) {
        ...
        FieldVisitor fv = cw.visitField(ACC_PUBLIC + ACC_STATIC, CONFIGURE_INIT_ATTEMPTED, GET_JBOOLEAN,
                null, null);
        fv.visitEnd();
        mv.visitInsn(ICONST_0);
        mv.visitFieldInsn(PUTSTATIC, innerClassName, CONFIGURE_INIT_ATTEMPTED, GET_JBOOLEAN);
        mv.visitInsn(RETURN);
    ...
    private void generateConfigInit(ClassWriter cw, Set<PackageID> imprtMods, PackageID packageID,
        ...
        mv.visitCode();
        mv.visitFieldInsn(GETSTATIC, innerClassName, CONFIGURE_INIT_ATTEMPTED, GET_JBOOLEAN);
