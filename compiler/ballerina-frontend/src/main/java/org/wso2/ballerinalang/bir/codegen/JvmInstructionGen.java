...
package org.wso2.ballerinalang.bir.codegen;

import io.ballerina.identifier.Utils;
import org.ballerinalang.compiler.BLangCompilerException;
import org.wso2.ballerinalang.model.elements.PackageID;
import org.wso2.ballerinalang.model.types.SelectivelyImmutableReferenceType;
import org.wso2.ballerinalang.model.types.TypeKind;
import org.objectweb.asm.Label;
import org.objectweb.asm.MethodVisitor;
import org.wso2.ballerinalang.bir.codegen.internal.AsyncDataCollector;
import org.wso2.ballerinalang.bir.codegen.internal.BIRVarToJVMIndexMap;
import org.wso2.ballerinalang.bir.codegen.internal.LambdaFunction;
import org.wso2.ballerinalang.bir.codegen.model.BIRFunctionWrapper;
import org.wso2.ballerinalang.bir.codegen.model.JCast;
import org.wso2.ballerinalang.bir.codegen.model.JInstruction;
import org.wso2.ballerinalang.bir.codegen.model.JLargeArrayInstruction;
import org.wso2.ballerinalang.bir.codegen.model.JLargeMapInstruction;
import org.wso2.ballerinalang.bir.codegen.model.JMethodCallInstruction;
import org.wso2.ballerinalang.bir.codegen.model.JType;
import org.wso2.ballerinalang.bir.codegen.model.JTypeTags;
import org.wso2.ballerinalang.bir.codegen.split.JvmConstantsGen;
import org.wso2.ballerinalang.bir.codegen.utils.JvmCodeGenUtil;
import org.wso2.ballerinalang.bir.model.BIRInstruction;
import org.wso2.ballerinalang.bir.model.BIRNode;
import org.wso2.ballerinalang.bir.model.BIRNonTerminator;
import org.wso2.ballerinalang.bir.model.BIRNonTerminator.FieldAccess;
import org.wso2.ballerinalang.bir.model.BIRNonTerminator.NewTable;
import org.wso2.ballerinalang.bir.model.BIROperand;
import org.wso2.ballerinalang.bir.model.InstructionKind;
import org.wso2.ballerinalang.semantics.analyzer.Types;
import org.wso2.ballerinalang.semantics.model.SymbolTable;
import org.wso2.ballerinalang.semantics.model.symbols.SchedulerPolicy;
import org.wso2.ballerinalang.semantics.model.symbols.Symbols;
import org.wso2.ballerinalang.semantics.model.types.BArrayType;
import org.wso2.ballerinalang.semantics.model.types.BIntersectionType;
import org.wso2.ballerinalang.semantics.model.types.BObjectType;
import org.wso2.ballerinalang.semantics.model.types.BRecordType;
import org.wso2.ballerinalang.semantics.model.types.BType;
...
import static org.wso2.ballerinalang.bir.codegen.JvmCastGen.getTargetClass;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.ADD_METHOD;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.ANNOTATION_MAP_NAME;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.ANNOTATION_UTILS;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.ARRAY_VALUE;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.ARRAY_VALUE_IMPL;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.BAL_ENV_CLASS;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.BYTE_VALUE;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.B_LIST_INITIAL_VALUE_ENTRY;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.B_MAPPING_INITIAL_VALUE_ENTRY;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.B_OBJECT;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.B_STRING_VALUE;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.CURRENT_MODULE_VAR_NAME;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.DECIMAL_VALUE;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.DOUBLE_VALUE;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.EQUALS_METHOD;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.ERROR_VALUE;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.FILL_AND_GET;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.FUNCTION_POINTER;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.FUNCTION_TYPE_CONSTANT_PACKAGE_NAME;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.GET_BOXED_VALUE;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.GET_ELEMENT;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.GET_ELEMENT_OR_NIL;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.GET_STRING_VALUE;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.GET_UNBOXED_BOOLEAN_VALUE;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.GET_UNBOXED_FLOAT_VALUE;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.GET_UNBOXED_INT_VALUE;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.GET_VALUE_METHOD;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.GLOBAL_CONSTANTS_PACKAGE_NAME;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.GLOBAL_VARIABLES_PACKAGE_NAME;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.HANDLE_VALUE;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.INSTANTIATE_FUNCTION;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.INT_VALUE;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.JSON_UTILS;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.JVM_INIT_METHOD;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.JVM_TO_UNSIGNED_INT_METHOD;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.LIST_INITIAL_EXPRESSION_ENTRY;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.LIST_INITIAL_SPREAD_ENTRY;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.LIST_INITIAL_VALUE_ENTRY;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.LONG_STREAM;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.MAPPING_INITIAL_KEY_VALUE_ENTRY;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.MAPPING_INITIAL_SPREAD_FIELD_ENTRY;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.MAP_UTILS;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.MAP_VALUE;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.MAP_VALUE_IMPL;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.MATH_UTILS;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.MODULE_INIT_CLASS_NAME;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.OBJECT_SELF_INSTANCE;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.OBJECT_TYPE_IMPL;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.RECORD_TYPE_IMPL;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.REG_EXP_FACTORY;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.SHORT_VALUE;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.STRING_UTILS;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.TABLE_UTILS;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.TABLE_VALUE;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.TABLE_VALUE_IMPL;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.TYPEDESC_VALUE;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.TYPEDESC_VALUE_IMPL;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.TYPE_CHECKER;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.VALUE_COMPARISON_UTILS;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.VALUE_OF_METHOD;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.VALUE_VAR_FIELD;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.XML_FACTORY;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.XML_QNAME;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.XML_VALUE;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.ANY_TO_JBOOLEAN;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.ARRAY_ADD_BSTRING;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.ARRAY_ADD_OBJECT;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.BAL_ENV_PARAM;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.BOBJECT_GET;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.BSTRING_CONCAT;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.CHECK_IS_TYPE;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.COMPARE_DECIMALS;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.COMPARE_OBJECTS;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.CREATE_REGEXP;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.CREATE_RE_ASSERTION;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.CREATE_RE_ATOM_QUANTIFIER;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.CREATE_RE_CAPTURING_GROUP;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.CREATE_RE_CHAR_CLASS;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.CREATE_RE_CHAR_SET;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.CREATE_RE_CHAR_SET_RANGE;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.CREATE_RE_DISJUNCTION;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.CREATE_RE_FLAG_EXPR;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.CREATE_RE_FLAG_ON_OFF;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.CREATE_RE_LITERAL_CHAR;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.CREATE_RE_QUANTIFIER;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.CREATE_RE_SEQUENCE;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.CREATE_XML_COMMENT;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.CREATE_XML_ELEMENT;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.CREATE_XML_PI;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.CREATE_XML_TEXT;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.CRETAE_XML_SEQUENCE;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.DECIMAL_NEGATE;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.DOUBLE_VALUE_OF_METHOD;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.FP_INIT;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.GET_ANNOTATION_VALUE;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.GET_BSTRING_FOR_ARRAY_INDEX;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.GET_FUNCTION_TYPE;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.GET_MAP_VALUE;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.GET_MODULE;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.GET_STRING_AT;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.GET_STRING_FROM_ARRAY;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.GET_TYPEDESC_OF_OBJECT;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.HANDLE_MAP_STORE;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.HANDLE_TABLE_STORE;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.INIT_ARRAY;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.INIT_ARRAY_WITH_INITIAL_VALUES;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.INIT_BAL_ENV;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.INIT_ERROR_WITH_TYPE;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.INIT_LIST_INITIAL_EXPRESSION_ENTRY;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.INIT_LIST_INITIAL_SPREAD_ENTRY;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.INIT_MAPPING_INITIAL_SPREAD_FIELD_ENTRY;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.INIT_TABLE_VALUE_IMPL;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.INIT_WITH_STRING;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.INIT_XML_QNAME;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.INSTANTIATE_WITH_INITIAL_VALUES;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.JSON_GET_ELEMENT;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.JSON_SET_ELEMENT;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.LONG_STREAM_RANGE_CLOSED;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.OBJECT_TYPE_DUPLICATE;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.OBJECT_TYPE_IMPL_INIT;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.PASS_B_STRING_RETURN_B_STRING;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.PASS_B_STRING_RETURN_UNBOXED_BOOLEAN;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.PASS_B_STRING_RETURN_UNBOXED_DOUBLE;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.PASS_B_STRING_RETURN_UNBOXED_LONG;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.PASS_OBJECT_RETURN_OBJECT;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.PROCESS_FP_ANNOTATIONS;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.PROCESS_OBJ_CTR_ANNOTATIONS;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.RETURN_OBJECT;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.SET_DECIMAL_RETURN_DECIMAL;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.SET_DEFAULT_VALUE_METHOD;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.SET_ON_INIT;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.TWO_OBJECTS_ARGS;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.TYPE_DESC_CONSTRUCTOR;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.TYPE_DESC_CONSTRUCTOR_WITH_ANNOTATIONS;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.XML_ADD_CHILDREN;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.XML_CHILDREN;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.XML_CHILDREN_FROM_STRING;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.XML_CONCAT;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.XML_GET_ATTRIBUTE;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.XML_GET_ITEM;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.XML_SET_ATTRIBUTE;
import static org.wso2.ballerinalang.bir.codegen.JvmTypeGen.getTypeDesc;
import static org.wso2.ballerinalang.bir.codegen.JvmValueGen.getTypeDescClassName;
import static org.wso2.ballerinalang.bir.codegen.JvmValueGen.getTypeValueClassName;
import static org.wso2.ballerinalang.bir.codegen.utils.JvmCodeGenUtil.canSkipFromCallByFunctionName;
import static org.wso2.ballerinalang.bir.codegen.utils.JvmCodeGenUtil.getVarStoreClass;
import static org.wso2.ballerinalang.bir.codegen.utils.JvmCodeGenUtil.loadConstantValue;
import static org.wso2.ballerinalang.bir.codegen.utils.JvmCodeGenUtil.loadStrand;
import static org.wso2.ballerinalang.bir.codegen.utils.JvmCodeGenUtil.toNameString;
import static org.wso2.ballerinalang.bir.codegen.utils.JvmModuleUtils.getModuleLevelClassName;
import static org.wso2.ballerinalang.bir.codegen.utils.JvmModuleUtils.getPackageName;
