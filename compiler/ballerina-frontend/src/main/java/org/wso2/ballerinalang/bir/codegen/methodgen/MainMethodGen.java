...
package org.wso2.ballerinalang.bir.codegen.methodgen;

import org.wso2.ballerinalang.model.elements.PackageID;
import org.wso2.ballerinalang.model.types.RecordType;
...
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.BALLERINA_HOME;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.BALLERINA_VERSION;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.BAL_RUNTIME;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.CLI_SPEC;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.COMPATIBILITY_CHECKER;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.CONFIGURATION_CLASS_NAME;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.CONFIGURE_INIT;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.CONFIG_DETAILS;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.CURRENT_MODULE_STOP_METHOD;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.CURRENT_MODULE_VAR_NAME;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.HANDLE_FUTURE_AND_EXIT_METHOD;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.HANDLE_FUTURE_AND_RETURN_IS_PANIC_METHOD;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.HANDLE_THROWABLE_METHOD;
...
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.LAMBDA_PREFIX;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.LAUNCH_UTILS;
...
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.REPOSITORY_IMPL;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.RUNTIME_UTILS;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.SCHEDULER;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.SCHEDULER_VARIABLE;
...
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.TEST_ARGUMENTS;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.TEST_CONFIG_ARGS;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.TEST_EXECUTION_STATE;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.VALUE_VAR_FIELD;
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.WAIT_ON_LISTENERS_METHOD_NAME;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.ADD_BALLERINA_INFO;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.ADD_SHUTDOWN_HOOK;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.CURRENT_MODULE_STOP;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.GET_CONFIG_DETAILS;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.GET_MAIN_ARGS;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.GET_MODULE;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.GET_PATH;
...
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.GET_STRING_ARRAY;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.GET_TEST_CONFIG_PATH;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.HANDLE_FUTURE;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.HANDLE_FUTURE_AND_RETURN_IS_PANIC;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.HANDLE_THROWABLE;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.INIT_CLI_SPEC;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.INIT_CONFIG;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.INIT_CONFIGURABLE;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.INIT_OPERAND;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.INIT_OPTION;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.INIT_RUNTIME;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.INIT_SIGNAL_LISTENER;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.INIT_TEST_ARGS;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.MAIN_METHOD_SIGNATURE;
import static org.wso2.ballerinalang.bir.codegen.JvmSignatures.METHOD_STRING_PARAM;
