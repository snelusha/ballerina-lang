...
package org.wso2.ballerinalang.bir.codegen.desugar;
...
import static org.wso2.ballerinalang.bir.codegen.JvmConstants.WRAPPER_GEN_BB_ID_NAME;
...
public final class BirDesugar {
    ...
    public static void addDefaultBooleanVarsToSignature(BIRFunction func) {
        func.type.paramTypes = updateParamTypesWithDefaultableBooleanVar(func.type.paramTypes, func.type.restType);
    }
