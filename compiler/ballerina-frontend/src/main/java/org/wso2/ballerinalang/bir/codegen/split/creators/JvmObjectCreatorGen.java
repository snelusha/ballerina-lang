 ...
 *  under the License.
 */
package org.wso2.ballerinalang.bir.codegen.split.creators;
...
public class JvmObjectCreatorGen {
    ...
    private void generateCreateObjectMethodSplits(ClassWriter cw, List<BIRTypeDefinition> objectTypeDefList,
        ...
        for (BIRTypeDefinition optionalTypeDef : objectTypeDefList) {
            ...
            String fieldName = toNameString(type);
            ...
            mv.visitInsn(DUP);
            String objectTypeClass = objectTypesPkgName + fieldName;
            mv.visitMethodInsn(INVOKESTATIC, objectTypeClass, GET_TYPE_METHOD, GET_OBJECT_TYPE_METHOD, false);
