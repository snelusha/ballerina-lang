 ...
 *  under the License.
 */
package org.wso2.ballerinalang.model;

import io.ballerina.types.Env;
import org.wso2.ballerinalang.model.clauses.CollectClauseNode;
import org.wso2.ballerinalang.model.clauses.DoClauseNode;
import org.wso2.ballerinalang.model.clauses.GroupByClauseNode;
import org.wso2.ballerinalang.model.clauses.GroupingKeyNode;
import org.wso2.ballerinalang.model.clauses.InputClauseNode;
import org.wso2.ballerinalang.model.clauses.LetClauseNode;
import org.wso2.ballerinalang.model.clauses.LimitClauseNode;
import org.wso2.ballerinalang.model.clauses.MatchClauseNode;
import org.wso2.ballerinalang.model.clauses.OnClauseNode;
import org.wso2.ballerinalang.model.clauses.OnConflictClauseNode;
import org.wso2.ballerinalang.model.clauses.OnFailClauseNode;
import org.wso2.ballerinalang.model.clauses.OrderByClauseNode;
import org.wso2.ballerinalang.model.clauses.OrderKeyNode;
import org.wso2.ballerinalang.model.clauses.SelectClauseNode;
import org.wso2.ballerinalang.model.clauses.WhereClauseNode;
import org.wso2.ballerinalang.model.tree.AnnotationAttachmentNode;
import org.wso2.ballerinalang.model.tree.AnnotationNode;
import org.wso2.ballerinalang.model.tree.BlockFunctionBodyNode;
import org.wso2.ballerinalang.model.tree.ClassDefinition;
import org.wso2.ballerinalang.model.tree.CompilationUnitNode;
import org.wso2.ballerinalang.model.tree.ErrorVariableNode;
import org.wso2.ballerinalang.model.tree.FunctionBodyNode;
import org.wso2.ballerinalang.model.tree.FunctionNode;
import org.wso2.ballerinalang.model.tree.IdentifierNode;
import org.wso2.ballerinalang.model.tree.ImportPackageNode;
import org.wso2.ballerinalang.model.tree.MarkdownDocumentationNode;
import org.wso2.ballerinalang.model.tree.MarkdownDocumentationReferenceAttributeNode;
import org.wso2.ballerinalang.model.tree.NodeKind;
import org.wso2.ballerinalang.model.tree.PackageNode;
import org.wso2.ballerinalang.model.tree.RecordVariableNode;
import org.wso2.ballerinalang.model.tree.RetrySpecNode;
import org.wso2.ballerinalang.model.tree.RetryTransactionNode;
import org.wso2.ballerinalang.model.tree.ServiceNode;
import org.wso2.ballerinalang.model.tree.SimpleVariableNode;
import org.wso2.ballerinalang.model.tree.TableKeySpecifierNode;
import org.wso2.ballerinalang.model.tree.TupleVariableNode;
import org.wso2.ballerinalang.model.tree.TypeDefinition;
import org.wso2.ballerinalang.model.tree.XMLNSDeclarationNode;
import org.wso2.ballerinalang.model.tree.bindingpattern.CaptureBindingPatternNode;
import org.wso2.ballerinalang.model.tree.bindingpattern.ErrorBindingPatternNode;
import org.wso2.ballerinalang.model.tree.bindingpattern.ErrorCauseBindingPatternNode;
import org.wso2.ballerinalang.model.tree.bindingpattern.ErrorFieldBindingPatternsNode;
import org.wso2.ballerinalang.model.tree.bindingpattern.ErrorMessageBindingPatternNode;
import org.wso2.ballerinalang.model.tree.bindingpattern.FieldBindingPatternNode;
import org.wso2.ballerinalang.model.tree.bindingpattern.ListBindingPatternNode;
import org.wso2.ballerinalang.model.tree.bindingpattern.MappingBindingPatternNode;
import org.wso2.ballerinalang.model.tree.bindingpattern.NamedArgBindingPatternNode;
import org.wso2.ballerinalang.model.tree.bindingpattern.RestBindingPatternNode;
import org.wso2.ballerinalang.model.tree.bindingpattern.SimpleBindingPatternNode;
import org.wso2.ballerinalang.model.tree.bindingpattern.WildCardBindingPatternNode;
import org.wso2.ballerinalang.model.tree.expressions.AnnotAccessNode;
import org.wso2.ballerinalang.model.tree.expressions.ArrowFunctionNode;
import org.wso2.ballerinalang.model.tree.expressions.BinaryExpressionNode;
import org.wso2.ballerinalang.model.tree.expressions.CheckPanickedExpressionNode;
import org.wso2.ballerinalang.model.tree.expressions.CheckedExpressionNode;
import org.wso2.ballerinalang.model.tree.expressions.CollectContextInvocationNode;
import org.wso2.ballerinalang.model.tree.expressions.ElvisExpressionNode;
import org.wso2.ballerinalang.model.tree.expressions.ErrorConstructorExpressionNode;
import org.wso2.ballerinalang.model.tree.expressions.ErrorVariableReferenceNode;
import org.wso2.ballerinalang.model.tree.expressions.ExpressionNode;
import org.wso2.ballerinalang.model.tree.expressions.FieldBasedAccessNode;
import org.wso2.ballerinalang.model.tree.expressions.GroupExpressionNode;
import org.wso2.ballerinalang.model.tree.expressions.IgnoreNode;
import org.wso2.ballerinalang.model.tree.expressions.IndexBasedAccessNode;
import org.wso2.ballerinalang.model.tree.expressions.InferredTypedescDefaultNode;
import org.wso2.ballerinalang.model.tree.expressions.InvocationNode;
import org.wso2.ballerinalang.model.tree.expressions.IsLikeExpressionNode;
import org.wso2.ballerinalang.model.tree.expressions.LambdaFunctionNode;
import org.wso2.ballerinalang.model.tree.expressions.LetExpressionNode;
import org.wso2.ballerinalang.model.tree.expressions.ListConstructorExprNode;
import org.wso2.ballerinalang.model.tree.expressions.LiteralNode;
import org.wso2.ballerinalang.model.tree.expressions.MarkDownDocumentationDeprecatedParametersAttributeNode;
import org.wso2.ballerinalang.model.tree.expressions.MarkDownDocumentationDeprecationAttributeNode;
import org.wso2.ballerinalang.model.tree.expressions.MarkdownDocumentationParameterAttributeNode;
import org.wso2.ballerinalang.model.tree.expressions.MarkdownDocumentationReturnParameterAttributeNode;
import org.wso2.ballerinalang.model.tree.expressions.MarkdownDocumentationTextAttributeNode;
import org.wso2.ballerinalang.model.tree.expressions.NamedArgNode;
import org.wso2.ballerinalang.model.tree.expressions.NaturalExpressionNode;
import org.wso2.ballerinalang.model.tree.expressions.QueryExpressionNode;
import org.wso2.ballerinalang.model.tree.expressions.RawTemplateLiteralNode;
import org.wso2.ballerinalang.model.tree.expressions.ReAssertionNode;
import org.wso2.ballerinalang.model.tree.expressions.ReAtomCharOrEscapeNode;
import org.wso2.ballerinalang.model.tree.expressions.ReAtomQuantifierNode;
import org.wso2.ballerinalang.model.tree.expressions.ReCapturingGroupsNode;
import org.wso2.ballerinalang.model.tree.expressions.ReCharSetNode;
import org.wso2.ballerinalang.model.tree.expressions.ReCharSetRangeNode;
import org.wso2.ballerinalang.model.tree.expressions.ReCharacterClassNode;
import org.wso2.ballerinalang.model.tree.expressions.ReDisjunctionNode;
import org.wso2.ballerinalang.model.tree.expressions.ReFlagExpressionNode;
import org.wso2.ballerinalang.model.tree.expressions.ReFlagsOnOffNode;
import org.wso2.ballerinalang.model.tree.expressions.ReQuantifierNode;
import org.wso2.ballerinalang.model.tree.expressions.ReSequenceNode;
import org.wso2.ballerinalang.model.tree.expressions.RecordLiteralNode;
import org.wso2.ballerinalang.model.tree.expressions.RecordVariableReferenceNode;
import org.wso2.ballerinalang.model.tree.expressions.RegExpTemplateLiteralNode;
import org.wso2.ballerinalang.model.tree.expressions.RestArgsNode;
import org.wso2.ballerinalang.model.tree.expressions.ServiceConstructorNode;
import org.wso2.ballerinalang.model.tree.expressions.SimpleVariableReferenceNode;
import org.wso2.ballerinalang.model.tree.expressions.StatementExpressionNode;
import org.wso2.ballerinalang.model.tree.expressions.StringTemplateLiteralNode;
import org.wso2.ballerinalang.model.tree.expressions.TableConstructorExprNode;
import org.wso2.ballerinalang.model.tree.expressions.TernaryExpressionNode;
import org.wso2.ballerinalang.model.tree.expressions.TrapExpressionNode;
import org.wso2.ballerinalang.model.tree.expressions.TupleVariableReferenceNode;
import org.wso2.ballerinalang.model.tree.expressions.TypeConversionNode;
import org.wso2.ballerinalang.model.tree.expressions.TypeInitNode;
import org.wso2.ballerinalang.model.tree.expressions.TypeTestExpressionNode;
import org.wso2.ballerinalang.model.tree.expressions.TypedescExpressionNode;
import org.wso2.ballerinalang.model.tree.expressions.UnaryExpressionNode;
import org.wso2.ballerinalang.model.tree.expressions.WorkerSendExpressionNode;
import org.wso2.ballerinalang.model.tree.expressions.XMLAttributeNode;
import org.wso2.ballerinalang.model.tree.expressions.XMLCommentLiteralNode;
import org.wso2.ballerinalang.model.tree.expressions.XMLElementLiteralNode;
import org.wso2.ballerinalang.model.tree.expressions.XMLLiteralNode;
import org.wso2.ballerinalang.model.tree.expressions.XMLProcessingInstructionLiteralNode;
import org.wso2.ballerinalang.model.tree.expressions.XMLQNameNode;
import org.wso2.ballerinalang.model.tree.expressions.XMLQuotedStringNode;
import org.wso2.ballerinalang.model.tree.expressions.XMLTextLiteralNode;
import org.wso2.ballerinalang.model.tree.matchpatterns.ConstPatternNode;
import org.wso2.ballerinalang.model.tree.matchpatterns.ErrorCauseMatchPatternNode;
import org.wso2.ballerinalang.model.tree.matchpatterns.ErrorFieldMatchPatternsNode;
import org.wso2.ballerinalang.model.tree.matchpatterns.ErrorMatchPatternNode;
import org.wso2.ballerinalang.model.tree.matchpatterns.ErrorMessageMatchPatternNode;
import org.wso2.ballerinalang.model.tree.matchpatterns.FieldMatchPatternNode;
import org.wso2.ballerinalang.model.tree.matchpatterns.ListMatchPatternNode;
import org.wso2.ballerinalang.model.tree.matchpatterns.MappingMatchPatternNode;
import org.wso2.ballerinalang.model.tree.matchpatterns.NamedArgMatchPatternNode;
import org.wso2.ballerinalang.model.tree.matchpatterns.RestMatchPatternNode;
import org.wso2.ballerinalang.model.tree.matchpatterns.SimpleMatchPatternNode;
import org.wso2.ballerinalang.model.tree.matchpatterns.VarBindingPatternMatchPatternNode;
import org.wso2.ballerinalang.model.tree.matchpatterns.WildCardMatchPatternNode;
import org.wso2.ballerinalang.model.tree.statements.AssignmentNode;
import org.wso2.ballerinalang.model.tree.statements.BlockStatementNode;
import org.wso2.ballerinalang.model.tree.statements.BreakNode;
import org.wso2.ballerinalang.model.tree.statements.CompoundAssignmentNode;
import org.wso2.ballerinalang.model.tree.statements.ConstantNode;
import org.wso2.ballerinalang.model.tree.statements.ContinueNode;
import org.wso2.ballerinalang.model.tree.statements.DoNode;
import org.wso2.ballerinalang.model.tree.statements.ErrorDestructureNode;
import org.wso2.ballerinalang.model.tree.statements.ExpressionStatementNode;
import org.wso2.ballerinalang.model.tree.statements.FailStatementNode;
import org.wso2.ballerinalang.model.tree.statements.ForeachNode;
import org.wso2.ballerinalang.model.tree.statements.ForkJoinNode;
import org.wso2.ballerinalang.model.tree.statements.IfNode;
import org.wso2.ballerinalang.model.tree.statements.LockNode;
import org.wso2.ballerinalang.model.tree.statements.MatchStatementNode;
import org.wso2.ballerinalang.model.tree.statements.PanicNode;
import org.wso2.ballerinalang.model.tree.statements.QueryActionNode;
import org.wso2.ballerinalang.model.tree.statements.RecordDestructureNode;
import org.wso2.ballerinalang.model.tree.statements.RetryNode;
import org.wso2.ballerinalang.model.tree.statements.ReturnNode;
import org.wso2.ballerinalang.model.tree.statements.RollbackNode;
import org.wso2.ballerinalang.model.tree.statements.TransactionNode;
import org.wso2.ballerinalang.model.tree.statements.TupleDestructureNode;
import org.wso2.ballerinalang.model.tree.statements.VariableDefinitionNode;
import org.wso2.ballerinalang.model.tree.statements.WhileNode;
import org.wso2.ballerinalang.model.tree.statements.WorkerReceiveNode;
import org.wso2.ballerinalang.model.tree.statements.XMLNSDeclStatementNode;
import org.wso2.ballerinalang.model.tree.types.ArrayTypeNode;
import org.wso2.ballerinalang.model.tree.types.BuiltInReferenceTypeNode;
import org.wso2.ballerinalang.model.tree.types.ConstrainedTypeNode;
import org.wso2.ballerinalang.model.tree.types.ErrorTypeNode;
import org.wso2.ballerinalang.model.tree.types.FiniteTypeNode;
import org.wso2.ballerinalang.model.tree.types.FunctionTypeNode;
import org.wso2.ballerinalang.model.tree.types.IntersectionTypeNode;
import org.wso2.ballerinalang.model.tree.types.ObjectTypeNode;
import org.wso2.ballerinalang.model.tree.types.RecordTypeNode;
import org.wso2.ballerinalang.model.tree.types.StreamTypeNode;
import org.wso2.ballerinalang.model.tree.types.TableTypeNode;
import org.wso2.ballerinalang.model.tree.types.TupleTypeNode;
import org.wso2.ballerinalang.model.tree.types.UnionTypeNode;
import org.wso2.ballerinalang.model.tree.types.UserDefinedTypeNode;
import org.wso2.ballerinalang.model.tree.types.ValueTypeNode;
