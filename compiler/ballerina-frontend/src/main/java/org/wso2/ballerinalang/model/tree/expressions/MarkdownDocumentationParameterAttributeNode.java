...
package org.wso2.ballerinalang.model.tree.expressions;
...
public interface MarkdownDocumentationParameterAttributeNode extends ExpressionNode {
    ...
    void setParameterName(IdentifierNode parameterName);

    List<String> getParameterDocumentationLines();

    void addParameterDocumentationLine(String description);
