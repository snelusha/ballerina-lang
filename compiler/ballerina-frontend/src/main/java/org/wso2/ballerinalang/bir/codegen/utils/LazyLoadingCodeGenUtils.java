...
import static org.wso2.ballerinalang.bir.codegen.utils.JvmCodeGenUtil.generateDiagnosticPos;
...
public final class LazyLoadingCodeGenUtils {
    ...
    public static void genLazyLoadingClass(ClassWriter cw, String lazyLoadingClass, String descriptor) {
        ...
        FieldVisitor fv = cw.visitField(ACC_PUBLIC + ACC_STATIC, VALUE_VAR_FIELD, descriptor, null, null);
        fv.visitEnd();
