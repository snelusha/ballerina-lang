...
import org.wso2.ballerinalang.model.elements.AttachPoint;
...
import static org.wso2.ballerinalang.bir.writer.BIRWriterUtils.writeConstValue;
...
public class BIRBinaryWriter {
    ...
    public byte[] serialize() {
        ...
        try (DataOutputStream dataOut = new DataOutputStream(baos)) {
            dataOut.write(BIRPackageFile.BIR_MAGIC);
            dataOut.writeInt(BIRPackageFile.BIR_VERSION);
